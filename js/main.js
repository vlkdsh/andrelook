...
const PRODUCTS = [
  ...
  },
  {
    ...
    names: {
      ...
      ru: 'Футболка Moncler с кожаным логотипом',
      et: 'Moncler nahkmärgiga T-shirt',
    },
    category: 't-shirts',
    cats: { en: 'T-Shirts', ru: 'Футболки', et: 'T-särgid' },
    descs: { ru: '', en: '', et: '' },
  ...
  },
  {
    ...
    names: {
      ...
      ru: 'Футболка Moncler с размытым логотипом',
      et: 'Moncler häguse logoga T-shirt',
    },
    category: 't-shirts',
    cats: { en: 'T-Shirts', ru: 'Футболки', et: 'T-särgid' },
    descs: { ru: '', en: '', et: '' },
  ...
  },
  {
    ...
    names: {
      ...
      ru: 'Худи на молнии Moncler с полосками',
      et: 'Moncler triibuga zip-kapuutsiga pusa',
    },
    category: 'hoodies',
  ...
  },
  {
    ...
    names: {
      ...
      ru: 'Свитшот Moncler Hera с нашивкой',
      et: 'Moncler Hera logomärgiga sweatshirt',
    },
    category: 'hoodies',
    cats: { en: 'Hoodies', ru: 'Худи', et: 'Kapuutsiga pusad' },
    descs: { ru: '', en: '', et: '' },
  ...
  },
  {
    ...
    names: {
      ...
      ru: 'Плавки Moncler с нашивкой',
      et: 'Moncler logomärgiga ujumispüksid',
    },
    category: 'bottoms',
